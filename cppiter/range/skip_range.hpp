...
public:
    skip_range(I begin, I end, iter::difference_t<I> n) :
        range_facade<I>{ { makeBeginIter<iter::category_t<I>>(begin, end, n) }, { end } }
    {}

private:
    template<typename C>
    I makeBeginIter(I begin, I end, iter::difference_t<I> n) {
