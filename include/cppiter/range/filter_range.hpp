...
class filter_range : public util::range_facade<iter::filter_iterator<util::range_iterator_t<R>, P>> {
...
private:
    filter_range(RngIt begin, RngIt end, P pred, std::forward_iterator_tag) :
        util::range_facade<FilterIt>{ FilterIt{ begin, end, pred }, FilterIt{ end, end, pred } }
    {}
